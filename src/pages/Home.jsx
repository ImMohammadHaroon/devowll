...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      'Ghulabdev made the path simple to follow. The structure helped me stay consistent and finish strong.',
  },
];
...
export default function Home() {
  return (
    <>
      <Seo
        title="Ghulabdev Remote Internship Programs"
        description="Ghulabdev helps learners find remote internship programs, build practical tech projects, and launch with mentorship and certification."
        path="/"
        keywords="Ghulabdev, remote internship, remote internship programs, tech internship, internship platform"
      />
