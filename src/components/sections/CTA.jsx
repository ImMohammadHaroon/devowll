    ...
    <section className="section-pad pt-0">
      <div className="container-page">
        <div className="rounded-[2rem] bg-slate-900 px-6 py-12 text-center text-white sm:px-10">
          ...
          <h2 className="mt-4 text-3xl font-bold sm:text-4xl">Join Ghulabdev and start building your career path.</h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-slate-300">
            Apply for an internship, explore services, or get in touch to learn how Ghulabdev can support your next step.
          </p>
